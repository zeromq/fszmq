...
#I "../../bin"
System.Environment.CurrentDirectory <- __SOURCE_DIRECTORY__ + "../../../bin"
...
automatically generated from `*.fsx` files in [the documentation folder][docs]. The API
reference is automatically generated from Markdown comments in the library implementation.

 * [Tutorial](tutorial.html) has more stuff
...
also want to read [library design notes](README.md) to understand how it works.

The library is available under the Apache license, which allows modification and 
redistribution for both commercial and non-commercial purposes. For more information see the 
[License file][license] in the GitHub repository. 

  [docs]: https://github.com/pblasucci/fszmq/tree/master/docs/content
